...
public class ReentrantedWaitNotify {
	...
	private void incrementCnt() {
		for (int i = 0; i < 100; i++) {
			System.out.println("increment call from " + Thread.currentThread().getName());
			cnt++;
		}
	}
	...
	public static void main(String[] args) {
		ReentrantedWaitNotify obj = new ReentrantedWaitNotify();
